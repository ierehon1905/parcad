...
pub mod ffi {
    ...
    unsafe extern "C++" {
        ...
        // shim in wrapper.hxx rather than a method binding.
        ...
        // ShapeFix — added for parcad, see PARCAD-CHANGES.md.
        pub fn ShapeFix_repair(
            shape: &TopoDS_Shape,
            precision: f64,
            max_tolerance: f64,
        ) -> UniquePtr<TopoDS_Shape>;
        ...
        /// PARCAD: the same mesher with its angular deflection and its
        /// parallel face pass given; see PARCAD-CHANGES.md.
        #[cxx_name = "construct_unique"]
