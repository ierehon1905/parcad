...
| `twisted-planter.js` | twisted star planter and drip saucer, two prints | the part the web playground opens first: a ruled loft twisted through nine star sections and hollowed along the same twist to a measured 2 mm wall, drain holes on `polar`, and a revolved saucer whose notched, rounded rings hold it clear of standing water |
