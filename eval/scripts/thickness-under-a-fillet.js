...
// round, it is thinner — down to 6 at the walls — and that is the wall the
// old distance-field sweep measured without: it dropped the fillet and read
// the sharp corner's 8 everywhere.
