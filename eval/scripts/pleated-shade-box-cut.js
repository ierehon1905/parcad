// examples/pleated-shade.js, its wall cut to a 60 mm box: keep the two in step.
...
return shade.thicken(wall).cut(slab.at(0, 0, rim - 10), slab.at(0, 0, height - rim + 10)).intersect(box(60, 60, 60).at(75, 0, 110));
