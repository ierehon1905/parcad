...
// location — and name a smaller radius measured to build (1.13 mm natively,
// 0.94 under WebAssembly; the corpus builds whichever it names), instead of
// blaming the radius or killing the worker.
