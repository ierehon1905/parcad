...
return machined
  ...
  .chamfer(0.4)
  .tag("bore_lead_in");
`,we=`// A toolroom V-block: a 90° vee that holds round stock on its axis, whichever
// diameter it is.
//
...
return machined
  ...
  .chamfer(1)
  .tag("vee_lip_break");
`,ye=`// A wash bottle: a turned body whose outline is one section — straight
...
`,ve="parcad-playground",c="parts",p="folders",S="meta",N="this browser's storage — parts here stay on this device. The installed app keeps them as files and serves MCP.";let H;function T(){return H??=new Promise((e,t)=>{const o=indexedDB.open(ve,1);o.onupgradeneeded=()=>{const a=o.result;a.createObjectStore(c,{keyPath:"path"}),a.createObjectStore(p),a.createObjectStore(S)},o.onsuccess=()=>e(o.result),o.onerror=()=>t(new Error(`this browser refused the playground its storage (${o.error?.message}); a private window may not allow it`))}).then(async e=>(await xe(e),e)),H}function x(e){return new Promise((t,o)=>{e.onsuccess=()=>t(e.result),e.onerror=()=>o(e.error)})}async function C(e){const t=await T();return x(t.transaction(e).objectStore(e).getAll())}async function E(){const e=await T();return await x(e.transaction(p).objectStore(p).getAllKeys())}async function d(e,t){const a=(await T()).transaction(e,"readwrite");t(a.objectStore(e)),await new Promise((s,r)=>{a.oncomplete=()=>s(),a.onerror=()=>r(a.error)})}async function _(e){const t=await T();return x(t.transaction(c).objectStore(c).get(e))}const v=()=>Math.floor(Date.now()/1e3),Te=Object.assign({"../../../examples/bracket.js":Z,"../../../examples/cast-foot.js":G,"../../../examples/clevis.js":U,"../../../examples/cover-plate.js":$,"../../../examples/diamond-v19.js":K,"../../../examples/display-bezel.js":J,"../../../examples/edge-fillets.js":Q,"../../../examples/enclosure.js":V,"../../../examples/extrusion-2020.js":ee,"../../../examples/flange.js":te,"../../../examples/fusion360/retainer-v1.js":ne,"../../../examples/fusion360/untitled2-v1.js":oe,"../../../examples/fusion360/untriangle-v3.js":ae,"../../../examples/heat-sink.js":se,"../../../examples/hex-standoff.js":re,"../../../examples/hydraulic-line.js":ie,"../../../examples/knurled-knob.js":he,"../../../examples/lidded-box.js":le,"../../../examples/manifold-block.js":ce,"../../../examples/motor-mount.js":de,"../../../examples/pillow-block.js":ue,"../../../examples/pipe-tee.js":pe,"../../../examples/plate-stand.js":be,"../../../examples/screw-top-jar.js":ge,"../../../examples/shaft-coupler.js":me,"../../../examples/timing-pulley.js":fe,"../../../examples/v-block.js":we,"../../../examples/wash-bottle.js":ye});async function xe(e){const t=e.transaction([c,S],"readwrite"),o=t.objectStore(S),a=t.objectStore(c),s=new Set(await x(o.get("seeded"))??[]);for(const[r,i]of Object.entries(Te).sort(([l],[n])=>l.localeCompare(n))){const l=r.replace(/^.*\/examples\//,"").replace(/\.js$/,"");s.has(l)||(a.put({path:l,script:i,tags:[],modified:v()}),s.add(l))}o.put([...s],"seeded"),await new Promise((r,i)=>{t.oncomplete=()=>r(),t.onerror=()=>i(t.error)})}const B=e=>e.split("/").pop()??e,_e=e=>e.replace(/[-_]/g," "),O=(e,t)=>e.name.toLowerCase()<t.name.toLowerCase()?-1:e.name.toLowerCase()>t.name.toLowerCase()?1:0;function j(e,t,o=""){const a=n=>o?n.startsWith(`${o}/`):!0,s=n=>o?n.slice(o.length+1):n,r=new Set;for(const n of[...t,...e.map(h=>h.path)]){if(!a(n))continue;const h=s(n).split("/");(h.length>1||t.includes(n))&&r.add(h[0])}const i=[...r].map(n=>{const h=o?`${o}/${n}`:n;return{kind:"folder",name:n,path:h,children:j(e,t,h)}}).sort(O),l=e.filter(n=>a(n.path)&&!s(n.path).includes("/")).map(n=>({kind:"part",name:B(n.path),path:n.path,title:n.title??_e(B(n.path)),bundle:!0,thumbnail:n.preview!==void 0,tags:n.tags,modified:n.modified})).sort(O);return[...i,...l]}function u(e){const t=e.split("/");for(const o of t)if(!o||o.startsWith(".")||/\.(js|parcad)$/.test(o)||/[\\:]/.test(o)||[...o].some(a=>a<" "))throw new Error(`${JSON.stringify(e)} is not a project name: each part of it must be a plain name, with no leading dot, extension, backslash or colon.`);return e}async function ke(){const[e,t]=await Promise.all([C(c),E()]);return{projects:e.map(o=>o.path).sort(),tree:j(e,t),directory:N}}async function k(e){const t=await _(u(e));if(!t)throw new Error(`no project called ${JSON.stringify(e)} in this browser.`);return t}async function De(e){return{script:(await k(e)).script}}async function Ae(e,t,o){const a=await _(u(e))??{path:e,script:t,tags:[],modified:v()};return await d(c,s=>s.put({...a,script:t,modified:v(),preview:o??a.preview})),{path:e}}async function Se(e,t){if(await _(u(e)))throw new Error(`${JSON.stringify(e)} already exists.`);return await d(c,o=>o.put({path:e,script:t,tags:[],modified:v()})),{path:e}}async function Ee(e){if((await E()).includes(u(e)))throw new Error(`${JSON.stringify(e)} already exists.`);return await d(p,o=>o.put(!0,e)),{path:e}}async function Re(e,t){u(e),u(t);const o=await C(c),a=await E();if(o.some(n=>n.path===t)||a.includes(t))throw new Error(`${JSON.stringify(t)} already exists.`);const s=n=>n===e||n.startsWith(`${e}/`),r=n=>t+n.slice(e.length),i=o.filter(n=>s(n.path)),l=a.filter(s);if(!i.length&&!l.length)throw new Error(`nothing at ${JSON.stringify(e)} to rename.`);return await d(c,n=>{for(const h of i)n.delete(h.path),n.put({...h,path:r(h.path)})}),await d(p,n=>{for(const h of l)n.delete(h),n.put(!0,r(h))}),{path:t}}async function ze(e,t){const o=await k(e);await d(c,a=>a.put({...o,title:t.trim()||void 0}))}async function He(e){const t=await k(e);return await d(c,o=>o.delete(t.path)),{trashed:"removed from this browser's storage"}}async function Be(e,t){const o=await k(e);await d(c,a=>a.put({...o,preview:t}))}async function Oe(e){return(await _(e))?.preview??null}const Pe=Object.freeze(Object.defineProperty({__proto__:null,DIRECTORY:N,create:Se,createFolder:Ee,list:ke,preview:Oe,read:De,remove:He,rename:Re,save:Ae,setPreview:Be,setTitle:ze},Symbol.toStringTag,{value:"Module"}));export{Le as kernel,Pe as store};
//# sourceMappingURL=index-DxfnAod8.js.map
