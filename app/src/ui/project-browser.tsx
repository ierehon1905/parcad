      ...
      >
        <span
          ...
          {...tip({
            ...
            text: "The app and parcad serve keep every part as a file in one folder, which you and any agent on MCP read and write too. ParCAD web has no folder and no MCP: its parts stay in that browser.",
          })}
        >
          {projects?.directory ?? ""}
        </span>
